...
def setup
  ...
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "codec", "Value" => "mpeg4dec"})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "maxBitRate", "Value" => get_max_bit_rate(@test_params.params_chan.video_bit_rate[0])})    
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "maxFrameRate", "Value" => '30000'})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "maxHeight", "Value" => [576, @test_params.params_chan.video_height[0].to_i].max.to_s})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "maxWidth", "Value" => [720, @test_params.params_chan.video_width[0].to_i].max.to_s})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "forceChromaFormat", "Value" => @test_params.params_chan.video_output_chroma_format[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "meRange", "Value" => @test_params.params_chan.video_me_range[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "decRotation", "Value" => @test_params.params_chan.video_rotation[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "umv", "Value" => @test_params.params_chan.video_use_umv[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "displayWidth", "Value" => @test_params.params_chan.video_width[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "frameSkipMode", "Value" => @test_params.params_chan.video_frame_skip_mode[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "frameOrder", "Value" => @test_params.params_chan.video_frame_order[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "newFrameFlag", "Value" => @test_params.params_chan.video_new_frame_flag[0]})
  @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" => "mbDataFlag", "Value" => @test_params.params_chan.video_mb_data_flag[0]})
...
def run
  #======================== Processing Media ====================================================
  begin
    file_res_form = ResultForm.new("MPEG4 Decoder Extended Parameters Test Result Form")
    @test_params.params_chan.video_source.each do |vid_source|
      ...
      @equipment['dut1'].set_param({"Class" => "mpeg4extdec", "Param" =>"numframes", "Value" => get_number_of_video_frames(vid_source)})
      @equipment['dut1'].mpeg4ext_decoding({"Source" => local_ref_file, "threadId" => 'mpeg4dec'})
  ...
  if file_res_form.test_result == FrameworkConstants::Result[:fail]
    @equipment['dut1'].get_param({"Class" => "mpeg4extdec", "Param" => ""})
