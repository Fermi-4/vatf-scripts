...
class DvtbH264LoopbackTestPlan < TestPlan
  ...
  def get_outputs(params)
     {
	     'testcaseID'     => "dvtb_h264_loopback.#{@current_id}",
	     'description'    => "H.264 Encoder Loopback Test using the encoders default values, a resolution of "+params['video_resolution']+",and a bit rate of "+params['video_bit_rate'], 
	     'ext' => false,
		 'iter' => '1',
		 'bft' => false,
		 'basic' => true,
		 'ext' => false,
		 'bestFinal' => false,
		 'script' => 'Common\A-DVTB_H264\dvtb_h264_loopback.rb',
		 'configID' => 'dvtb_h264_loopback.ini',
		 'reg'                       => true,
		 'auto'                     => true,
		 'paramsChan'     => {
