...
class DvtbH264G711LoopbackTestPlan < TestPlan
  ...
  def setup()
	#@order = 2
	@group_by = ['video_rate_control', 'video_resolution']
	@sort_by = ['video_rate_control', 'video_resolution','video_bit_rate','video_frame_rate']
	@auto_gen = ['inputs']
  end
  # END_USR_CFG setup
  ...
  def get_outputs(params)
     {
		 ...
		 'ext' => false,
		 'bestFinal' => false,
		 'script' => 'Common\A-DVTB_H264_G711_YUV_LOOPBACK\dvtb_h264_g711.rb',
