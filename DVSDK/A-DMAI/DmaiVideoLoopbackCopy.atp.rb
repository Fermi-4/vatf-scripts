...
class DmaiVideoLoopbackCopyTestPlan < TestPlan
	# BEG_USR_CFG setup
  # General setup:
  def setup()
	@order = 2
  ...
  def get_params()
      ...
      @res_params = {
          ...
          'display_standard' => ['fbdev', 'v4l2', 'default'],
          'display_device'  => ['/dev/fb3'],
          'use_accelerator' => ['yes','no'],
          'output_position' => ['0x0','default'],
          'input_position' => ['0x0','default'],
          'enable_smooth'  => ['yes', 'no'],
          'crop'         =>  ['yes', 'no'],
          'display_time' => [10],
          'max_num_files' => [1]
      }
  ...
  def get_outputs(params)
     {
	     'testcaseID'  	=> "dmai_video_loopback_copy.#{@current_id}",
		 ...
		 'paramsChan' 	=> {
        'command_name'			=> 'video_loopback_copy',
        ...
        'display_standard' => params['display_standard'],
        'display_device'  => params['display_device'],
        'use_accelerator' => params['use_accelerator'],
        'output_position' => params['output_position'],
        'input_position' => params['input_position'],
        'enable_smooth'  => params['enable_smooth'],
        'crop'         =>  params['crop'],
  ...
  def get_test_description(params)
      "Video loopback copy dmai test with resolution #{params['resolution']}"
  end
