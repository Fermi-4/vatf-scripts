...
class DvtbH264G711EncFileFuncTestPlan < TestPlan
	# BEG_USR_CFG setup
  # General setup:
  def setup()
	@order = 2
  ...
  def get_outputs(params)
     {
	     'testcaseID'     => "dvtb_h264_g711_enc_file_func.#{@current_id}",
	     'description'    => "H264_G711 Encode file Functionality Test using the encoders default values, a resolution of "+get_video_resolution(params)+",and a bit rate of "+get_video_bit_rate(params), 
		 'script' => 'Common\A-DVTB_H264_G711_ENC_FILE\dvtb_h264_g711_enc_file_func.rb',
		 'configID' => '..\Config\dvtb_h264_g711_enc_file_func.ini', 
	     'ext' => false,
		 'iter' => '1',
		 'bft' => false,
		 'basic' => true,
