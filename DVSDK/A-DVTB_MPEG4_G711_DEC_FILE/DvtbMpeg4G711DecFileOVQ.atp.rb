...
class DvtbMpeg4G711DecFileOVQTestPlan < TestPlan
  # BEG_USR_CFG setup
  # General setup:
  def setup()
    @order = 2
  ...
  def get_outputs(params)
    {
	'description'		=>"MPEG4 + G711 Decode from file Objective Quality Test for video resolution = #{get_video_resolution(params)}, video bit rate = #{get_video_bit_rate(params)}, and audio companding = #{params['audio_companding']}",
	
									
    'iter'                       => '1',
    'testcaseID'                 => "dvtb_mpeg4_g711_dec_file_ovq.#{@current_id}",
    'bft'                        => false,
    'basic'                      => false,
    'ext'                        => true,
    'reg'                        => false,
    'auto'                       => false,
    'bestFinal'               => false,
    'script'                     => 'Common\A-DVTB_MPEG4_G711_DEC_FILE\dvtb_mpeg4_g711_dec_file_ovq.rb',
    ...
    'configID'      => '..\Config\dvtb_mpeg4_g711_dec_file_ovq.ini',
    'last'            => true,
   }
  end
