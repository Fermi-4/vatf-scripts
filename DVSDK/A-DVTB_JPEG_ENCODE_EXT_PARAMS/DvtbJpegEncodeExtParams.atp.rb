...
class DvtbJpegEncodeExtParamsTestPlan < TestPlan
  ...
  def get_constraints()
	...
	'IF [picture_iface_type] IN {"vga","hdmi","dvi","sdi"} THEN [picture_signal_format] IN {"1080i50", "1080i59", "1080i60", "720p50", "720p59", "720p60", "1080p23", "1080p24", "1080p25", "1080p29", "1080p30", "1080p50", "1080p59", "1080p60"};',
	'IF [picture_signal_format] = "dummy" THEN [picture_source] = "media_filer";',
	]
  end
  ...
  def get_outputs(params)
    ...
    'auto'                       => true,
    'bestFinal'                  => false,
    'script'                     => 'Common\A-DVTB_JPEG_ENCODE_EXT_PARAMS\dvtb_jpeg_enc_ext_params.rb',
    ...
    'paramsChan'                 => {
		...
		'picture_reset_interval' => get_reset_interval(params),
    },
