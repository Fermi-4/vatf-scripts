...
NETWORK_REFERENCE_FILES_FOLDER = '//gtpegasus/SystemTest_refs/VISA/Image/Encoder'      # TODO: Make sure this is the right place
...
def setup
  ...
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "codec", "Value" => "jpegenc"})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "maxHeight", "Value" => @test_params.params_chan.picture_height[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "maxWidth", "Value" => @test_params.params_chan.picture_width[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "maxScans", "Value" => @test_params.params_chan.picture_num_scans[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "dataEndianness", "Value" => @test_params.params_chan.picture_data_endianness[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "forceChromaFormat", "Value" => @test_params.params_chan.picture_output_chroma_format[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "inputChromaFormat", "Value" => @test_params.params_chan.picture_input_chroma_format[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "inputHeight", "Value" => @test_params.params_chan.picture_input_height[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "inputWidth", "Value" => @test_params.params_chan.picture_input_width[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "captureWidth", "Value" => @test_params.params_chan.picture_signal_format[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "captureHeight", "Value" => @test_params.params_chan.picture_height[0]}) #Commented out because dvtb doe not support this parameter
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "generateHeader", "Value" => '0'})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "qValue", "Value" => @test_params.params_chan.picture_quality[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "numAU", "Value" => @test_params.params_chan.picture_num_access_units[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "dynParamsRstInterval", "Value" => @test_params.params_chan.picture_reset_interval[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "dynParamsDisableEOI", "Value" => @test_params.params_chan.picture_disable_eoi[0]})
  @equipment['dut1'].set_param({"Class" => "jpegextenc", "Param" => "dynParamsRotation", "Value" => @test_params.params_chan.picture_rotation[0]})
  ...
  begin
    ...
    if @test_params.params_chan.picture_source[0].eql?("dvd") || @test_params.params_chan.picture_source[0].eql?("camera")
      ...
      0.upto(channel_number) do |ch_num|
        ...
        @equipment['dut1'].jpegext_encoding({"Target" => test_file, "threadId" => 'jpegenc'})
        @equipment['dut1'].wait_for_threads
      end  
    else
      @test_params.params_chan.picture_source.each do |source_file|
        puts "Encoding #{source_file} ........."
        test_file = LOCAL_FILES_FOLDER+source_file.gsub(".yuv","_at_"+@test_params.params_chan.picture_quality[0]+"qual_"+@test_params.params_chan.picture_input_width[0]+"x"+@test_params.params_chan.picture_input_height[0]+"_"+@test_params.params_chan.picture_output_chroma_format[0]+"_test.jpg")
        File.delete(test_file) if File.exists?(test_file)
        ref_file,local_ref_file = get_ref_file(NETWORK_REFERENCE_FILES_FOLDER,source_file)
