    ...
    if @test_params.params_chan.test_type[0].include?("vpfe") && @test_params.params_chan.test_type[0].include?("vpbe")
      ...
      0.upto(channel_number) do |ch_num|
        ...
        if @test_params.params_chan.test_type[0].include?("resize")
            ...
            test_file = @test_params.params_chan.video_source[0]+'_'+@test_params.params_chan.video_width[0]+'x'+@test_params.params_chan.video_height[0]+'_'+@test_params.params_chan.video_bit_rate[0].sub(/000$/,"kbps_")+@test_params.params_chan.video_frame_rate[0]+'fps_channel'+ch_num.to_s+'.264'
            @equipment['dut1'].video_encoding({"function" => "videncr", "Target" => test_file, "threadId" => 'h264enc'})
          end
        else
          if ch_num == channel_number
            ...
            test_file = @test_params.params_chan.video_source[0]+'_'+@test_params.params_chan.video_width[0]+'x'+@test_params.params_chan.video_height[0]+'_'+@test_params.params_chan.video_bit_rate[0].sub(/000$/,"kbps_")+@test_params.params_chan.video_frame_rate[0]+'fps_channel'+ch_num.to_s+'.264'
            @equipment['dut1'].video_encoding("Target" => test_file, "threadId" => 'h264enc')
          end
        end
