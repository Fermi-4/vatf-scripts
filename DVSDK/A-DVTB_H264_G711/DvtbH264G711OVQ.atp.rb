...
class DvtbH264G711OVQTestPlan < TestPlan
  ...
  'description'    => get_test_description(params),
      'iter'                       => '1',
        'testcaseID'                 => "dvtb_h264_g711_ovq.#{@current_id}",
        'bft'                        => false,
        'basic'                      => false,
        'ext'                        => true,
        'reg'                        => false,
        'auto'                       => true,
        'bestFinal'                  => false,
        'script'                     => 'Common\A-DVTB_H264_G711\dvtb_h264_g711_ovq.rb',
        'configID'      => '..\Config\dvtb_h264_g711_ovq.ini',
        # channel parameters
        'paramsChan'                => {
  ...
  def get_test_description(params)
    description = "Objective Quality Test H264 and G711 " + get_test_type(params) + " test, "
