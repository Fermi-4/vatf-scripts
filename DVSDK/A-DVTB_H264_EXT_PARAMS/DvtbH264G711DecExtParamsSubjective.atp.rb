...
class DvtbH264G711DecExtParamsSubjectiveTestPlan < TestPlan
  ...
  @video_source_hash = get_source_files_hash("\\w+",params['video_resolution'],@h264_prof_regex,file_bit_rate,"\\w*","264")
  ...
  'description'    =>"H264 Decoder Extended parameters test with, video_res=#{get_video_resolution(params)},bit_rate=#{get_video_bit_rate(params)}",
    ...
    'auto'                       => true,
    'bestFinal'               => false,
    'script'                     => 'Common\A-DVTB_H264_EXT_PARAMS\dvtb_h264_g711_dec_ext_params_subjective.rb',
    ...
    'paramsChan'                => {
      ...
      'video_reset_hdivc_every_frame' => params['video_reset_hdivc_every_frame'],
      'video_disable_hdivc_every_frame' => params['video_disable_hdivc_every_frame'],
      ...
      'video_display_delay' => params['video_display_delay'],
 ...
 #   'last'            => true,
  ...
  def get_video_source(params)
    ...
    video_source = @video_source_hash["\\w+"+video_resolution+@h264_prof_regex+file_bit_rate+"\\w*"].to_s
