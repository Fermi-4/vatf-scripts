...
class DvtbH264ExtParamsTestPlan < TestPlan
  ...
  @video_source_hash = get_source_files_hash("\\w*",common_params['video_resolution'],"_\\w*_{0,1}",common_params['video_source_chroma_format'],"\\w*_\\d{3}frames","yuv")
  ...
  @video_source_hash = @video_source_hash.merge!(get_source_files_hash("\\w+",common_params['video_resolution'],"_",common_params['video_input_chroma_format'],"\\w*",common_params['video_bit_rate'],"bps","264"))
  @video_source_hash = @video_source_hash.merge!(get_source_files_hash("\\w+",common_params['video_resolution'],"_(BP|MP)\\w*",file_bit_rate,"\\w*","264"))
   ...
   max_mb_per_slice = get_max_mb_per_slice(params)
     {
       ...
       'ext' => false,
       'bestFinal' => false,
       'script' => 'Common\A-DVTB_H264_EXT_PARAMS\dvtb_h264_g711_ext_params.rb',
       'configID' => '..\Config\dvtb_h264_g711_ext_params.ini',
       'reg'                       => true,
       'auto'                     => true,
       'paramsChan'     => {
  ...
  # END_USR_CFG get_outputs
   ...
   def get_video_source(params)
    ...
    if params['video_input_driver'] == 'none'
      ...
      video_source = @video_source_hash["\\w*"+video_resolution+"_\\w*_{0,1}"+params['video_source_chroma_format']+"\\w*_\\d{3}frames"].to_s
    end
