...
class DvtbMpeg4G711EncFileTestPlan < TestPlan
  # BEG_USR_CFG setup
  # General setup:
  def setup()
    @order = 2
  ...
  def get_outputs(params)
    {
	'description'		=>"MPEG4 G711 Encode File Test, video_res=#{get_video_resolution(params)}, frame_rate=#{params['video_frame_rate']},bit_rate=#{get_video_bit_rate(params)}",
	
									
    'iter'                       => '1',
    'testcaseID'                 => "dvtb_mpeg4_g711_enc_file.#{@current_id}",
    'bft'                        => false,
    'basic'                      => false,
    'ext'                        => true,
    'reg'                        => false,
    'auto'                       => false,
    'bestFinal'               => false,
    'script'                     => 'Common\A-DVTB_MPEG4_G711_ENC_FILE\dvtb_mpeg4_g711_enc_file.rb',
    ...
    'configID'      => '..\Config\dvtb_mpeg4_g711_enc_file.ini',
    'last'            => true,
   }
  end
