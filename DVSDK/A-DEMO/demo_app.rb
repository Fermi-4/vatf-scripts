...
def run
	...
	test_comment = ''
	@connection_handler.make_video_connection({@equipment["video_tester"] => 0}, {@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0},"sdi")
	@connection_handler.make_video_connection({@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0}, {@equipment["video_tester"] => 0}, "sdi")	
	@connection_handler.make_video_connection({@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0}, {@equipment["dut1"] => 0, @equipment["tv0"] => 0},@test_params.params_chan.video_input[0]) 
    @connection_handler.make_audio_connection({@equipment["audio_player"] => 0},{@equipment["dut1"] => 0, @equipment["tv0"] => 0}, 'mini35mm')   
    @connection_handler.make_audio_connection({@equipment["audio_player"] => 0},{@equipment["dut1"] => 1}, 'mini35mm')
    @connection_handler.make_audio_connection({@equipment["dut1"] => 0},{@equipment["audio_player"] => 0, @equipment['tv1'] => 0}, 'mini35mm')
	...
	@test_params.params_chan.video_source.each do |vid_source|
		...
		if @test_params.params_chan.command_name[0].include?("multi_encode")
            ref_file, local_ref_file = get_ref_file(NETWORK_REFERENCE_FILES_FOLDER+'Video/Encoder', vid_source)
            test_file = LOCAL_FILES_FOLDER+@test_params.params_chan.video_file[0]
            raw_video_test_file = test_file.sub(/\..+$/,'_'+@test_params.params_chan.video_source_chroma_format[0]+'_rawconv.yuv')
            test_file_video_tester = @test_params.params_chan.video_file[0]=~/\.mpeg4$/ ? raw_video_test_file : test_file
            ...
            @connection_handler.make_video_connection({@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0},{@equipment["#{@test_params.params_chan.video_input[0]}_converter"] =>0},@test_params.params_chan.video_input[0])
            puts "Encoding #{vid_source} ....."
            multi_enc_params = get_multi_encode_params(vid_source)
            video_tester_result = @equipment['video_tester'].video_out_to_file_test(vid_enc_params){
                @equipment['dut1'].multi_encode(multi_enc_params)
            	...
            	@equipment['dut1'].wait_for_threads(multi_enc_params['time'].to_i + 120)
            	...
            	get_raw_video_file(test_file,raw_video_test_file, @test_params.params_chan.video_source_chroma_format[0]) if @test_params.params_chan.video_file[0]=~/\.mpeg4$/
            }	
        elsif @test_params.params_chan.command_name[0].include?("encode") && @test_params.params_chan.command_name[0].include?("decode")
            ref_file, local_ref_file = get_ref_file(NETWORK_REFERENCE_FILES_FOLDER+'Video/Encoder', vid_source)
			...
			video_tester_result = @equipment['video_tester'].video_out_to_video_in_test(vid_enc_dec_params){
				 @connection_handler.make_video_connection({@equipment["dut1"] => 0},{@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0},@test_params.params_chan.display_out[0])
				 sleep 1 
				 audio_ref_file, audio_test_file, audio_input_handle, audio_output_handle = run_audio_process() if @test_params.params_chan.speech_file[0] != 'none'
			 }
            bytes_rec, audio_input_handle, audio_output_handle = stop_audio_process(audio_input_handle, audio_output_handle) if @test_params.params_chan.speech_file[0] != 'none'
            ...
            video_tester_result = @equipment['video_tester'].video_out_to_file_test(vid_enc_params){
            	...
            	get_raw_video_file(test_file,raw_video_test_file, '422i') if @test_params.params_chan.video_file[0]=~/\.mpeg4$/
            }	      
			...
			File.copy(companded_local_ref_file, LOCAL_FILES_FOLDER+@test_params.params_chan.audio_source[0]+".g711")
			companded_local_ref_file = LOCAL_FILES_FOLDER+@test_params.params_chan.audio_source[0]+".g711"
			if @test_params.params_chan.video_file[0]=~/\.mpeg4$/
			...
			ref_file_video_tester = @test_params.params_chan.video_file[0]=~/\.mpeg4$/ ? raw_video_ref_file : local_ref_file
			vid_dec_params = {'ref_clip' => ref_file_video_tester, 'test_clip' =>  test_file, 'format' => @test_params.params_chan.video_signal_format[0],
							  'num_frames' => get_te_video_num_frames(vid_source), 'metric_window' => metric_window, 'data_format' => @test_params.params_chan.video_source_chroma_format[0],
			...
			@connection_handler.make_video_connection({@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0},{@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0, @equipment['tv0'] => 0},@test_params.params_chan.display_out[0])
			puts "Decoding #{vid_source} ....."
			video_tester_result = @equipment['video_tester'].file_to_video_in_test(vid_dec_params){
				@equipment['dut1'].decode(get_decode_params(local_ref_file, companded_local_ref_file))
				@connection_handler.make_video_connection({@equipment["dut1"] => 0},{@equipment["#{@test_params.params_chan.video_input[0]}_converter"] => 0},@test_params.params_chan.display_out[0])
            	audio_ref_file, audio_test_file, audio_input_handle, audio_output_handle = run_audio_process() if @test_params.params_chan.speech_file[0] != 'none'
            }
...
def get_multi_encode_params(vid_source)
    h={
        'speech_file' 			=> LOCAL_FILES_FOLDER+@test_params.params_chan.speech_file[0],
        'video_file'			=> LOCAL_FILES_FOLDER+@test_params.params_chan.video_file[0],
