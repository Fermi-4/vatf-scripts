...
class DvtbH264G711DecFileTestPlan < TestPlan
  ...
  def get_outputs(params)
     {
	     'testcaseID'     => "dvtb_h264_g711_dec_file.#{@current_id}",
	     'description'    => "H.264+g711 Decoder Test using the encoders default values, a resolution of "+get_video_resolution(params)+",and a bit rate of "+get_video_bit_rate(params), 
	     'ext' => false,
		 'iter' => '1',
		 'bft' => false,
		 'basic' => true,
		 'ext' => false,
		 'bestFinal' => false,
		 'script' => 'Common\A-DVTB_H264_G711_DEC_FILE\dvtb_h264_g711_dec_file.rb',
		 'configID' => 'dvtb_h264_g711_dec_file.ini',
		 'reg'                       => true,
		 'auto'                     => true,
		 'paramsChan'     => {
