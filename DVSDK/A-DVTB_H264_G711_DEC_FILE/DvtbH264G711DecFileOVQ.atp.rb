...
class DvtbH264G711DecFileOVQTestPlan < TestPlan
  ...
  def get_outputs(params)
     {
	     'testcaseID'     => "dvtb_h264_g711_dec_file_ovq.#{@current_id}",
	     'description'    => "H.264+g711 Decoder Objective Quality Test using the encoders default values, a resolution of "+get_video_resolution(params)+",and a bit rate of "+get_video_bit_rate(params), 
	     'ext' => false,
		 'iter' => '1',
		 'bft' => false,
		 'basic' => true,
		 'ext' => false,
		 'bestFinal' => false,
		 'script' => 'Common\A-DVTB_H264_G711_DEC_FILE\dvtb_h264_g711_dec_file_ovq.rb',
		 'configID' => 'dvtb_h264_g711_dec_file_ovq.ini',
		 'reg'                       => true,
		 'auto'                     => true,
		 'paramsChan'     => {
