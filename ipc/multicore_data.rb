module MulticoreData
  ...
  def get_data(platform, test, data)
    ...
    (0..data_list[evm]['MESSAGEQ']['CORES'].length - 2).each do |i|
      data_list[evm]['MESSAGEQ']['BINARIES'][i] = "/examples/#{platform_token[evm]}/ex02_messageq/core#{i}/bin/debug/server_core#{i}.xe66"
      data_list[evm]['MESSAGEQ']['ROV'][i] = "/examples/#{platform_token[evm]}/ex02_messageq/core#{i}/bin/debug/configuro/package/cfg/Core#{i}_pe66.rov.xs"
    end
    data_list[evm]['MESSAGEQ']['BINARIES'][data_list[evm]['MESSAGEQ']['CORES'].length - 1] = "/examples/#{platform_token[evm]}/ex02_messageq/host/bin/debug/app_host.xa15fg"
    data_list[evm]['MESSAGEQ']['ROV'][data_list[evm]['MESSAGEQ']['CORES'].length - 1] = "/examples/#{platform_token[evm]}/ex02_messageq/host/bin/debug/configuro/package/cfg/Host_pa15fg.rov.xs"
