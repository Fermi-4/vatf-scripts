module DSPGlobConfig
	...
	dut.send_cmd("dimt dsp_glob_config 1 alloc_g 32 ",/DONE/,2) 
	
	dut.send_cmd("xdp rtcp 1", /DONE/, 2)
    dut.send_cmd("cc rtcp_dsp_sdes 0 1 @telogy_0.com", /DONE/, 2)
	dut.send_cmd("cc rtcp_dsp_sdes 1 1 @telogy_0.com", /DONE/, 2)
	dut.send_cmd("cc rtcp_dsp_sdes 2 1 @telogy_0.com", /DONE/, 2)
	dut.send_cmd("cc rtcp_dsp_sdes 3 1 @telogy_0.com", /DONE/, 2)
	dut.send_cmd("cc rtcp_dsp_sdes 4 1 @telogy_0.com", /DONE/, 2)
	dut.send_cmd("cc rtcp_dsp_sdes 5 1 @telogy_0.com", /DONE/, 2)
    end
