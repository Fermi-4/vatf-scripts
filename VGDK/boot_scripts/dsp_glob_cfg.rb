module DSPGlobConfig
    ...
    dut.send_cmd("dimt reset template 32",/OK/,2) 
    dut.send_cmd("dimt set template 32 dsp_glob_config stream_encap_config ctrl enable",/OK/,2) 

    dut.send_cmd("dimt dsp_glob_config 0 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 1 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 2 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 3 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 4 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 5 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 6 alloc_g 32 ",/OK/,2) 
    dut.send_cmd("dimt dsp_glob_config 7 alloc_g 32 ",/OK/,2) 
    ...
    dut.send_cmd("cc rtcp_dsp_sdes 6 1 @telogy_5.com", /OK/, 2)
    dut.send_cmd("cc rtcp_dsp_sdes 7 1 @telogy_5.com", /OK/, 2)
    end
