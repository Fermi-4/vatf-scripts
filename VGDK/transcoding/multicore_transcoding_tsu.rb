    ...
    (codec_hash).each_pair{|codec,res_arr| 
      ...
      #CONF-CONNECT TEMPLATE
        if neu_rout == "true"
          ...
          dut.send_cmd("dimt reset template 6", /OK/, 10)
        ...
        when "dec"
          ...
          set_codec_cfg(dut,codec,nil,multislice,"dec_dyn",decoder_template,"default",default_params,res.core)
          set_codec_cfg(dut,codec,res.resolution,multislice,"dec_st",decoder_template,"test",nil,res.core)
          set_codec_cfg(dut,codec,res.resolution,multislice,"dec_dyn",decoder_template,"test",nil,res.core)
        when "enc"
          set_codec_cfg(dut,codec,nil,multislice,"enc_st",encoder_template,"default",default_params,res.core)
