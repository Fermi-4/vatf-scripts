...
if not exist "!DEBUGSERVER_ROOT!" set DEBUGSERVER_ROOT=%~dp0..\..\..\xulrunner
...
if not exist "!%DEBUGSERVER_ROOT!\win32" goto invalidpath

REM set PATHs for DSS
set PATH=!DSS_ROOT!\common\bin;!PATH!
set PATH=!DSS_ROOT!\common\uscif;!PATH!

REM Run generic loader.
CMD /C java.exe -DXPCOM.RUNTIME="!DEBUGSERVER_ROOT!\win32" -cp "!RHINO_JAR!;!SCRIPTING_JAR!" !RHINO_SHELL! "!LOADTI_JS!" %PARAM01% %PARAM02% %PARAM03% %PARAM04% %PARAM05% %PARAM06% %PARAM07% %PARAM08% %PARAM09% %PARAM10% %PARAM11% %PARAM12% %PARAM13% %PARAM14% %PARAM15% %PARAM16% %PARAM17% %PARAM18% %PARAM19% %PARAM20% %PARAM21% %PARAM22% %PARAM23% %PARAM24% %PARAM25% %PARAM26% %PARAM27% %PARAM28% %PARAM29% %PARAM30% %PARAM31% %PARAM32% %PARAM33% %PARAM34% %PARAM35% %PARAM36% %PARAM37% %PARAM38% %PARAM39% %PARAM40%
