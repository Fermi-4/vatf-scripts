...
#include "st_nand_parser.h"


/***************************************************************************
 * Function		- nand_parser
 * Functionality	- NAND test functionality Parser
 * Input Params	- None
 * Return Value	- None
 * Note			- None
 ****************************************************************************/
void nand_parser(void)
{
	int i=0;
	char cmd[CMD_LENGTH];
	...
	i=0;
        ...
        {
            printTerminalf("Exiting from nand mode to Main Parser: \n");
            break;
        }
 ...
 ****************************************************************************/
	void ST_NAND_MountFormat(void)
	{
		...
		{
			if(ST_PASS==ST_System("mount -t jffs2 /dev/mtdblock0  /nand/"))
				printTerminalf("ST_NAND_MountFormat: Completed successfully\n");
			else
				printTerminalf("ST_NAND_MountFormat: Failed\n");
		}
		else
			printTerminalf("ST_NAND_MountFormat: Failed\n");			
	}
...
/***************************************************************************
 * Function		- ST_NAND_Ioctl
 * Functionality	- NAND IOCTL Test user Interface  functionality
 * Input Params	- None
 * Return Value	- None
 * Note			- None
 ****************************************************************************/
void ST_NAND_Ioctl(void)
{
	...
	printTerminalf("region_info:			Gets the No.of Blocks, Erase Size..of the MTD Device\n");		
...
/***************************************************************************
 * Function		- ST_Nand_stress
 * Functionality	- NAND Stress Test user Interface  functionality
 * Input Params	- None
 * Return Value	- None
 * Note			- None
 ****************************************************************************/
