...
//  do_hdd_bytes  = 10737418240; /* 10MB Size of File */
  ...
  strcpy( gST_MntPoint, mnt_point);
  strcat (gST_MntPoint, "/stress.XXXXXX");

  out (stdout, "Mount Point %s \n", gST_MntPoint);
