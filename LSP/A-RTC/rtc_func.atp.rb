class Rtc_funcTestPlan < TestPlan
  ...
  def get_manual()
    ...
    tc = [
      ...
      },
      {
        ...
        'paramsChan'  => common_paramsChan.merge({  
          #'is_set_time' => 1,
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"7/31/2008 05:40:00\"`--(#{fail_string})`;hwclock`++Jul 31 05:40:\\d+ 2008`",
        }),
      },
      {
        ...
        'paramsChan'  => common_paramsChan.merge({  
          #'is_set_time' => 1,
          'cmd' => "[dut_timeout\\=30];hwclock`--(#{fail_string})`", # repeat sending this cmd
      ...
      },
      {
        ...
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"12/31/2007 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"1/31/2007 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"1/30/2008 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"12/31/2007 22:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"12/31/2007 20:50:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"12/31/2007 23:59:00\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"02/29/2008 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"02/28/2007 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"02/28/xxxx 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"03/31/2008 23:59:50\"`--(#{fail_string})`" +
      ...
      },
      {
        ...
        'testcaseID'   => 'rtc_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "[dut_timeout\\=30];hwclock --set --date \"12/31/1969 23:59:00\"`++(Invalid|fail)`" +
                  ";hwclock --set --date \"01/19/2038 03:14:07\"`++(Invalid|fail|cannot)`" +
