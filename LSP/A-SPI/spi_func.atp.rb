class Spi_funcTestPlan < TestPlan
    ...
    keys = [
      {
        ...
        'micro'     => ['default', 'pio'],            # 'micro' key is used to select the operation mode. Valud values are pio | dma | polled
  ...
  def get_manual()
    ...
    tc = [
      {
        'description'  => "Verify that the Driver can be configured to operate in different modes -- Interrupt mode.", 
      ...
      {
        'description'  => "Verify that the Driver can be configured to operate in different modes -- Polled mode.", 
        'testcaseID'   => 'spi_func_0001',
        'paramsChan'  => common_paramsChan.merge({        
        }),
        'auto'        => false,
