class HRTimer_funcTestPlan < TestPlan
  ...
  def get_manual()
    ...
    tc = [
      {
        'description'  => " Verify the HRT support by the kernel. " +
                        "\r\n Test Procedure >>>" +
                        "\r\n 1.Issue make menuconfig command in the  kernel prompt ." +
                        "\r\n 2.Navigate to Linux> System type and features --->[*] Configure High-Resolution-Timers." +
                        "\r\n HRT Support should be present",
        'testcaseID'   => 'hrtimer_func_0001',
        'paramsChan'  => common_paramsChan.merge({        
        }),
        'auto'        => false,
      },
      {
        'description'  => " Verify the proc entry support by the kernel." +
                        "\r\n Test Procedure >>>" +
                        "\r\n 1.Issue make menuconfig command in the kernel prompt ." +
                        "\r\n 2.Navigate to Linux> System type and features --->[*] Configure High-Resolution-Timers." +
                        "\r\n The timer should be listed as proc entry",        
        'testcaseID'   => 'hrtimer_func_0002',
      ...
      {
        'description'  => " Verify the kernel logs for messages related to the timer feature" +
                        " when High resolution feature enabled." +
                        "\r\n Test Procedure >>>" +
                        "\r\n 1.Enable the feature on the CPUs that you require the feature and perfrom the build." +
                        "\r\n 2.Load the DUT with this image." +
                        "\r\n 3.Log the boot up console logs." +
                        "\r\n The Boot up log should report: \"Switched to high resolution mode on CPU n on all CPUs\" where the feature is enabled.",        
        'testcaseID'   => 'hrtimer_func_0003',
        'paramsChan'  => common_paramsChan.merge({ 
        }),
        'auto'  => false,
      },
      {
        'description'  => "Verify the kernel logs for messages related to the timer feature" +
                        " when High resolution feature disabled." +
                        "\r\n Test Procedure >>>" +
                        "\r\n 1.Enable the feature on the CPUs that you require the feature and perfrom the build." +
                        "\r\n 2.Load the DUT with this image." +
                        "\r\n 3.Log the boot up console logs." +
                        "\r\n The Boot up log should not report: \"Switched to high resolution mode on CPU n on all CPUs\" where the feature is enabled.",        
        'testcaseID'   => 'hrtimer_func_0004',
        'paramsChan'  => common_paramsChan.merge({ 
        }),
        'auto'  => false,
      },
      {
        'description'  => "Verify that the hardware timer used for HRT is as per the design and are optimally configured." +
                        " when High resolution feature disabled." +
                        "\r\n Test Procedure >>>" +
                        "\r\n 1.TBD." +
                        "\r\n 2.TBD." +
    ...
    iperiod.each { |i|
      tc_append << 
      {
        'description'  => "Verify that the accuracy of the HRT with interval #{i} seconds." +
                        "\r\n Test Procedure >>>" +
    ...
    tc_append = [
      ...
      },
      {
        ...
        'paramsChan'  => common_paramsChan.merge({ 
          ...
          'expected_resolution' => "1",  # in ns
          'time_to_finish'  => "5",   # the program should get over in this time. otherwise, it is not hr.
        }),
      },
      {
        'description'  => "Verify the functioning of the timer after the system goes through various power management states." +
                        "\r\n Test Procedure >>>" +
                        "\r\n 1.Start timing for a periods of 5minutes." +
                        "\r\n 2.Switch between various power management states." +
                        "\r\n 3.Wait for the timer to time out with thin the specified period." +
                        "\r\n The deviation from the Wall clock time interval should be not more than 1 sec.",        
        'testcaseID'   => 'timer_func_0002',
        'script'  => 'LSP\default_test_script.rb',
        'auto'    => false,
        'paramsChan'  => common_paramsChan.merge({ 
          'cmd' => "",
