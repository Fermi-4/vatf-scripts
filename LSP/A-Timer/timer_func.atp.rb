class Timer_funcTestPlan < TestPlan
  ...
  def get_manual()
    ...
    tc = [
      {
        'description'  => "Verify the presence on timer support in Menu config setting.", 
        'testcaseID'   => 'timer_func_0001',
        'paramsChan'  => common_paramsChan.merge({        
        }),
        'auto'        => false,
      },
      {
        'description'  => "Verify that the Timer is initialized by calling gettimeofday().", 
      ...
      {
        'description'  => "Verify the Target Clock is in Sync with the Host Clock ( OR a Standard Clock ). ",
