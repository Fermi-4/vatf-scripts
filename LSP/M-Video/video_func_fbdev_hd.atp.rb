...
class Video_func_fbdev_hdTestPlan < TestPlan
    include Fbdev_hd_common
  def initialize()
    super
  end
  # BEG_USR_CFG setup
    ...
    tc = [
      {
        ...
        'testcaseID'   => 'fbdev_dynamic_hd_mod_0001',
      ...
      },
      {
        ...
        'testcaseID'   => 'fbdev_dynamic_hd_mod_0002',
        'paramsChan'  => common_paramsChan.merge({
        'cmd' => ' ' #./st_parser audio open 2 1 ioctl get_ver`++Success::--Failed::`' 
        }),
      },
      {
        'description'  =>  "Verify that the video loopback works fine in looping back a 720P format video with a OSD0 window and OSD1 as blending.",
        'testcaseID'   => 'fbdev_dynamic_hd_mod_0003',
        'paramsChan'  => common_paramsChan.merge({
        'cmd' => ' ' #./st_parser audio open 2 1 ioctl get_ver`++Success::--Failed::`' 
        }),
      },
      {
        'description'  =>  "Verify that the video loopback works fine in looping back a 1080I format video with a OSD0 window and OSD1 as blending..",
  ...
  def get_outputs(params)
    {
        'testcaseID'     => "video_fbdev_capture_hd.#{@current_id}",
        'description'	=> "Fbdev HD Functionality test in  #{get_in_fmt(params['Out_Fmt'])} format.",
        'iter'         => 1,
        'bft'          => true,
        'basic'        => true,
        'ext'          => false,
        ...
        'bestFinal'    => true,
        'configID'     => '..\Config\lsp_generic.ini',
        'script'       => 'LSP\M-Video\video_func_fbdev_hd.rb',
        'paramsChan'   => {
