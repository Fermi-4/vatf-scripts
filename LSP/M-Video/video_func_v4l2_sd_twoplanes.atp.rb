...
class Video_func_v4l2_sd_twoplanesTestPlan < TestPlan
  ...
  def get_outputs(params)
    {
        'testcaseID'     => "video_v4l2_capture_sd_twoplanes.#{@current_id}",
        'description'	=> "V4L2 Functionality test with #{get_input(params['Input_vid'])} input and #{get_output(params['Output'])} Output in #{get_out_fmt(params['Out_Fmt'])}" +
