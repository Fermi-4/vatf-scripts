class Video_cap_func_inputTestPlan < TestPlan
  ...
  def get_manual()
    ...
    tc = [
      {
        'description'  =>  "Verify that the video capture can be set to COMPOSITE input." +
                                      "/r/n This test verified Enumerating the input, setting the input" +
      ...
      {
        'description'  =>  "Verify that the video capture can be set to SVIDEO input" +
                                      "/r/n This test verified Enumerating the input, setting the input" +
                                      "and verifying the input that is set",
      ...
      {
        'description'  =>  "Verify that the video capture can be set to COMPONENT input"+
                                      "/r/n This test verified Enumerating the input, setting the input" +
                                      "and verifying the input that is set" ,
