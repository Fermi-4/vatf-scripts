class Video_func_prevTestPlan < TestPlan
  ...
  def get_manual()
    ...
    tc = [
      {
        'description'  =>  "Verify that the Previewer in DM6446 can convert successfully the raw image to YUV422 Image" +
                                     "This test also verifies the Ioctls PREV_REQBUFS,PREV_S_PARAMS,PREV_QUERYBUFS" +
                                     "also mmaping the buffer for Previewer device",
