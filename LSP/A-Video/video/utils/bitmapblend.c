 ...
 * 
 * Function: Verify FBIO_SET_BITMAP_BLEND_FACTOR.
 *
*/
/* Header files */
#include <stdio.h>
...
int main(int argc, char *argv[])
{
 ...
 vpbe_bitmap_blend_params_t bitmapblend;
  ...
  if ( argc != 4 ){
                 printf ("Format:\t bitblend [window] [blend-factor] [enable_colorkey]\n");
  ...
  //If enable_colorkey is 1, then enter color key.
  // color key defines the degree of transparency of OSD window with the
  // video window. if colorkey is greater than 0, OSD is opaque.
