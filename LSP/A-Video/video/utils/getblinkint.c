/*
 * Filename: getblinkint.c
 * 
 * Function: Verify FBIO_GET_BLINK_INTERVAL.
 *
 * Reads the OSD1 frame buffer to get the blink interval.
 * OSD1 should be in attribute mode
*/
/* Header files */
#include <stdio.h>
#include <sys/ioctl.h>
...
int main(int argc,char *argv[])
{
 ...
 if(ioctl(fd,FBIO_GET_BLINK_INTERVAL,&blinkInfo) < 0){
                  perror("FBIO_GET_BLINK_INTERVAL Failed:");
