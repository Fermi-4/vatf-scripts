...
./omap35xV4l2DisplayTests --help

#Prints the version
./omap35xV4l2DisplayTests -v

#Runs the default color bar display-No options provided
./omap35xV4l2DisplayTests 
...
./omap35xV4l2DisplayTests -w 720 -h 480 -c 3 -n 1000
...
./omap35xV4l2DisplayTests -T api -t apitests

#Run the stability Test
./omap35xV4l2DisplayTests -T stability

#Displays the file stefan_qvga_422.yuv
#Showing the usage- Commented because cannit ship the yuv files as part of package and yuv file names can be different.Just showing the usage here
#./omap35xV4l2DisplayTests -f stefan_qvga_422.yuv -w 320 -h 240

#runs the default color bar test with PAL standard
./omap35xV4l2DisplayTests -s pal

#Stress Test- Run the display test overnight- Displays default color bar with number of buffers queued is 4 overnight
./omap35xV4l2DisplayTests -c 4 -n 864000 -t stress
...
./omap35xV4l2DisplayTests -t sep30_lsprelease_080_test
...
./omap35xV4l2DisplayTests -d /dev/video1 -T stability -C 10
