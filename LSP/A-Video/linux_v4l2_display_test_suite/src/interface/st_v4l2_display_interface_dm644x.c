...
/* Default settings/values for display tests */
...
#define DEFAULT_PIX_FMT  V4L2_PIX_FMT_UYVY
...
/* Display width ,height, buffersize and pitch */
int dispwidth;
int dispheight;
int sizeimage;
int disppitch;
 ...
 * Functionality        - This function tries the settings for V4L2_DISPLAY width,height & pixel
 * format
 * Input Params         - V4L2_DISPLAY, device number,width,height & pix fmt
 * Return Value         - 0: SUCCESS, -1: FAILURE
 * Note                 - None
 ...
 * Input Params         - device number,no of buffers to request for
 * Return Value         - 0: SUCCESS, -1: FAILURE
 * Note                 - None
 ****************************************************************************/
 ...
 * Functionality        - This function implements the QUERYBUF ioctl and mmap
 *                        used for file display operations
 * Input Params         - device number
 * Return Value         - 0: SUCCESS, -1: FAILURE
 * Note                 - None
 ****************************************************************************/
 ...
 * Functionality        - This function enqueues the buffers(Wrapper for
 *                        QBUF)-Used in case of color bar display
 * Input Params         - device number
 * Return Value         - 0: SUCCESS, -1: FAILURE
 * Note                 - None
 ****************************************************************************/
 ...
 * Functionality        - This function does the display of some bar pattern
 * Input Params         - device number,number of frames to display
 * Return Value         - 0: SUCCESS, -1: FAILURE
 * Note                 - None
 ****************************************************************************/
...
/****************************************************************************
 * Function             - st_v4l2_display_setcrop_interface
 * Functionality        - This function implements the S_CROP ioctl(with zoom)
 * Input Params         - device number
 * Return Value         - 0: SUCCESS, -1: FAILURE
 * Note                 - None
 ****************************************************************************/
 ...
 * Functionality        - This function is not required to be implemented as
 *                        DM646x supports only 1 pixel format
 * Input Params         - None
 ...
 * Functionality        - This function needs to be implemented 
 * Input Params         - None
 ...
 * Functionality        - This function enables the display
 * Input Params         - None
 * Return Value         - None
 * Note                 - None
 ****************************************************************************/
...
void print_v4l2_display_test_params(struct v4l2_display_testparams *testoptions)
{
    ...
    DBG_PRINT_TRC0(("The number of buffers enqueued | %d\n",testoptions->noofbuffers));
    DBG_PRINT_TRC0(("The number of frames to be displayed | %d\n",testoptions->noofframes));
}
...
void display_v4l2_display_test_suite_help(void)
{
    ...
    printf("Usage:\n"
            ...
            "-d       --displaynode     Device node on which display test is to be run\n"
                                        "\t\t\t\tPossible values-/dev/video2,/dev/video3\n"
            ...
            "-f       --filename        Name of the image file to display\n"
                                        "\t\t\t\t Make sure the file is as per -w(width),-h(height) configured & in UYVY format\n"
