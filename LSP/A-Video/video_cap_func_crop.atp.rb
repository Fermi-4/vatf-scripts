class Video_cap_func_cropTestPlan < TestPlan
  ...
  def get_manual()
    ...
    tc = [
      {
        'description'  =>  "Verify that the video capture can be Cropped" +
                                      "/r/n This test verified by first checking the capabilities of CROPPING and then setting the crop" +
                                      "(width 320 height 240 and verifying the cropping that is set by getting the crop and" +
