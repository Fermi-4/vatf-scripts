...
def run
  ...
  if partition_map[uboot_version] != result
    set_result(FrameworkConstants::Result[:fail], "Expected #{partition_map[uboot_version]} but found #{result}")
  else
